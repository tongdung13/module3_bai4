...
<div class="container">
    <div class="card">
        ...
        <div class="form-group">
            <form method="post" action="{{ route('contacts.update', $contacts->id) }}" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label>Name</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="fullName" value="{{ $contacts->fullName }}" class="form-control">
                </div>
                <div class="form-group">
                    <label>Email</label>
